...
% error vs correct
subplot(442); [b, bint] = Uncertainty_byErrorCorrect('rt');
...
subplot(475); plotBetasSwarm(b, colors([1 2], :));
...
subplot(4,7,14); plotBetasSwarm(b, [0.5 0.5 0.5; 0.2 0.2 0.2]);
